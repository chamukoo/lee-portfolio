    ...
    return (
        <div className="relative text-white h-screen overflow-hidden">
            ...
            <div className="relative max-w-[800px] mt-[-96px] w-full h-full mx-auto text-center flex flex-col justify-center items-center">
                ...
                <p className="p-2 md:text-2xl sm:text-1xl font-medium text-gray-400">
                    Currently a Third-year Computer Engineering student at the Polytechnic University of the Philippines.
                </p>
                <button type="button" class="mt-4 text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Let's Connect</button>
